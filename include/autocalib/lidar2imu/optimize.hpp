...
struct BalmVoxelEnergy3 {
  BalmVoxelEnergy3(
      ...
      const std::vector<Eigen::Matrix4d,Eigen::aligned_allocator<Eigen::Matrix4d>> &imu_trans)
  ...
  const std::vector<Eigen::Matrix4d,Eigen::aligned_allocator<Eigen::Matrix4d>> imu_trans_;
};
